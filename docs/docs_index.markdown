...
Bem-vindo à documentação do **GodMode-MCTrilhas**, um plugin para o servidor **MC Trilhas** (Paper 1.21.5) com temática escoteira. Este plugin implementa um sistema de insígnias que recompensa jogadores por completar tarefas como cortar árvores, minerar, cozinhar e construir, integrado com Vault (moeda Totem) e WorldGuard (áreas restritas).
